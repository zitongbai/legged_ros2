...
void UnitreeSdk2Bridge::PublishLowStateGo()
{
    if (mj_data_)
    {
        ...
        low_state_go_.crc() = Crc32Core((uint32_t *)&low_state_go_, (sizeof(unitree_go::msg::dds_::LowState_) >> 2) - 1);
...
void UnitreeSdk2Bridge::PublishLowStateHg()
{
    if (mj_data_)
    {
        ...
        low_state_hg_.crc() = Crc32Core((uint32_t *)&low_state_hg_, (sizeof(unitree_hg::msg::dds_::LowState_) >> 2) - 1);
